...
VulkanComputePipelineScreen::VulkanComputePipelineScreen(VulkanContext *context)
	: m_context(context) {}

VulkanComputePipelineScreen::~VulkanComputePipelineScreen() = default;

void VulkanComputePipelineScreen::create(Allocator *allocator, VulkanShader *computeShader) {
	{
...
void VulkanComputePipelineScreen::destroy() {
...
void VulkanComputePipelineScreen::bind_pipeline(VkCommandBuffer cmd) {
...
void VulkanComputePipelineScreen::bind_push_constants(VkCommandBuffer cmd, char *data) {
	vkCmdPushConstants(cmd, m_layout, VK_SHADER_STAGE_COMPUTE_BIT, 0, 128, data);
}

void VulkanComputePipelineScreen::draw(VkCommandBuffer cmd) {
